...
CREATE OR REPLACE FUNCTION "public"."generate_repair_number"() RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  year_part TEXT;
...
ALTER FUNCTION "public"."generate_repair_number"() OWNER TO "postgres";
...
ALTER TABLE "public"."qc_checklist_items" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."qc_production_steps" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "value" "text" NOT NULL,
    "label" "text" NOT NULL,
    "sort_order" integer DEFAULT 0 NOT NULL,
...
ALTER TABLE "public"."qc_production_steps" OWNER TO "postgres";
...
ALTER TABLE "public"."qc_submissions" OWNER TO "postgres";
...
ALTER TABLE "public"."repair_actions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."repair_issues" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "repair_issues_severity_check" CHECK (("severity" = ANY (ARRAY['cosmetic'::"text", 'functional'::"text", 'critical'::"text"])))
);


ALTER TABLE "public"."repair_issues" OWNER TO "postgres";
...
ALTER TABLE "public"."repair_knowledge_base" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."repair_notifications" (
    ...
    "sent_at" timestamp with time zone,
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "repair_notifications_notification_type_check" CHECK (("notification_type" = ANY (ARRAY['intake_confirmation'::"text", 'diagnosis_complete'::"text", 'approval_required'::"text", 'work_started'::"text", 'completed'::"text", 'shipped'::"text"])))
);


ALTER TABLE "public"."repair_notifications" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."repair_orders" (
    ...
    CONSTRAINT "repair_orders_order_type_check" CHECK (("order_type" = ANY (ARRAY['customer_return'::"text", 'warranty'::"text", 'internal_qc'::"text"]))),
    CONSTRAINT "repair_orders_priority_check" CHECK (("priority" = ANY (ARRAY['standard'::"text", 'rush'::"text"]))),
    CONSTRAINT "repair_orders_repair_source_check" CHECK (("repair_source" = ANY (ARRAY['customer'::"text", 'internal'::"text"]))),
    CONSTRAINT "repair_orders_repair_type_check" CHECK (("repair_type" = ANY (ARRAY['production'::"text", 'finishing'::"text", 'sonic'::"text"]))),
    CONSTRAINT "repair_orders_status_check" CHECK (("status" = ANY (ARRAY['intake'::"text", 'diagnosed'::"text", 'approved'::"text", 'in_progress'::"text", 'testing'::"text", 'completed'::"text", 'shipped'::"text"])))
);
...
ALTER TABLE "public"."repair_parts_used" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."repair_photos" (
    ...
    CONSTRAINT "repair_photos_photo_type_check" CHECK (("photo_type" = ANY (ARRAY['intake'::"text", 'diagnosis'::"text", 'before'::"text", 'after'::"text", 'completed'::"text"])))
);


ALTER TABLE "public"."repair_photos" OWNER TO "postgres";
...
ALTER TABLE "public"."repair_time_logs" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."qc_production_steps"
    ADD CONSTRAINT "qc_production_steps_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."qc_production_steps"
    ADD CONSTRAINT "qc_production_steps_value_key" UNIQUE ("value");
...
ALTER TABLE ONLY "public"."qc_submissions"
    ADD CONSTRAINT "qc_submissions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."repair_actions"
    ADD CONSTRAINT "repair_actions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."repair_issues"
    ADD CONSTRAINT "repair_issues_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."repair_knowledge_base"
    ADD CONSTRAINT "repair_knowledge_base_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."repair_orders"
    ADD CONSTRAINT "repair_orders_repair_number_key" UNIQUE ("repair_number");



ALTER TABLE ONLY "public"."repair_parts_used"
    ADD CONSTRAINT "repair_parts_used_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."repair_photos"
    ADD CONSTRAINT "repair_photos_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."repair_time_logs"
    ADD CONSTRAINT "repair_time_logs_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_qc_checklist_items_is_active" ON "public"."qc_checklist_items" USING "btree" ("is_active");
...
CREATE INDEX "idx_repair_actions_repair_order_id" ON "public"."repair_actions" USING "btree" ("repair_order_id");



CREATE INDEX "idx_repair_issues_repair_order_id" ON "public"."repair_issues" USING "btree" ("repair_order_id");



CREATE INDEX "idx_repair_knowledge_base_model_category" ON "public"."repair_knowledge_base" USING "btree" ("model", "issue_category");



CREATE INDEX "idx_repair_orders_assigned_to" ON "public"."repair_orders" USING "btree" ("assigned_to");
...
CREATE INDEX "idx_repair_orders_customer_email" ON "public"."repair_orders" USING "btree" ("customer_email");



CREATE INDEX "idx_repair_orders_repair_number" ON "public"."repair_orders" USING "btree" ("repair_number");



CREATE INDEX "idx_repair_orders_status" ON "public"."repair_orders" USING "btree" ("status");



CREATE INDEX "idx_repair_time_logs_repair_order_id" ON "public"."repair_time_logs" USING "btree" ("repair_order_id");



CREATE INDEX "idx_repair_time_logs_worker_id" ON "public"."repair_time_logs" USING "btree" ("worker_id");
...
CREATE OR REPLACE TRIGGER "update_qc_checklist_items_updated_at" BEFORE UPDATE ON "public"."qc_checklist_items" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_qc_production_steps_updated_at" BEFORE UPDATE ON "public"."qc_production_steps" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_repair_knowledge_base_updated_at" BEFORE UPDATE ON "public"."repair_knowledge_base" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();



CREATE OR REPLACE TRIGGER "update_repair_orders_updated_at" BEFORE UPDATE ON "public"."repair_orders" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."qc_checklist_items"
    ADD CONSTRAINT "qc_checklist_items_production_step_value_fkey" FOREIGN KEY ("production_step_value") REFERENCES "public"."qc_production_steps"("value") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."qc_submissions"
    ADD CONSTRAINT "qc_submissions_worker_id_fkey" FOREIGN KEY ("worker_id") REFERENCES "public"."workers"("id");
...
ALTER TABLE ONLY "public"."repair_actions"
    ADD CONSTRAINT "repair_actions_performed_by_fkey" FOREIGN KEY ("performed_by") REFERENCES "public"."workers"("id");



ALTER TABLE ONLY "public"."repair_actions"
    ADD CONSTRAINT "repair_actions_repair_order_id_fkey" FOREIGN KEY ("repair_order_id") REFERENCES "public"."repair_orders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."repair_issues"
    ADD CONSTRAINT "repair_issues_discovered_by_fkey" FOREIGN KEY ("discovered_by") REFERENCES "public"."workers"("id");



ALTER TABLE ONLY "public"."repair_issues"
    ADD CONSTRAINT "repair_issues_repair_order_id_fkey" FOREIGN KEY ("repair_order_id") REFERENCES "public"."repair_orders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."repair_knowledge_base"
    ADD CONSTRAINT "repair_knowledge_base_repair_order_id_fkey" FOREIGN KEY ("repair_order_id") REFERENCES "public"."repair_orders"("id");



ALTER TABLE ONLY "public"."repair_knowledge_base"
    ADD CONSTRAINT "repair_knowledge_base_technician_id_fkey" FOREIGN KEY ("technician_id") REFERENCES "public"."workers"("id");



ALTER TABLE ONLY "public"."repair_notifications"
    ADD CONSTRAINT "repair_notifications_repair_order_id_fkey" FOREIGN KEY ("repair_order_id") REFERENCES "public"."repair_orders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."repair_orders"
    ADD CONSTRAINT "repair_orders_assigned_to_fkey" FOREIGN KEY ("assigned_to") REFERENCES "public"."workers"("id");



ALTER TABLE ONLY "public"."repair_orders"
    ADD CONSTRAINT "repair_orders_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."workers"("id");



ALTER TABLE ONLY "public"."repair_orders"
    ADD CONSTRAINT "repair_orders_original_order_id_fkey" FOREIGN KEY ("original_order_id") REFERENCES "public"."orders"("id");



ALTER TABLE ONLY "public"."repair_parts_used"
    ADD CONSTRAINT "repair_parts_used_repair_action_id_fkey" FOREIGN KEY ("repair_action_id") REFERENCES "public"."repair_actions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."repair_photos"
    ADD CONSTRAINT "repair_photos_repair_order_id_fkey" FOREIGN KEY ("repair_order_id") REFERENCES "public"."repair_orders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."repair_photos"
    ADD CONSTRAINT "repair_photos_uploaded_by_fkey" FOREIGN KEY ("uploaded_by") REFERENCES "public"."workers"("id");



ALTER TABLE ONLY "public"."repair_time_logs"
    ADD CONSTRAINT "repair_time_logs_repair_order_id_fkey" FOREIGN KEY ("repair_order_id") REFERENCES "public"."repair_orders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."repair_time_logs"
    ADD CONSTRAINT "repair_time_logs_worker_id_fkey" FOREIGN KEY ("worker_id") REFERENCES "public"."workers"("id");
...
CREATE POLICY "Authenticated users can view active checklist items" ON "public"."qc_checklist_items" FOR SELECT TO "authenticated" USING (("is_active" = true));
...
CREATE POLICY "Only managers can modify QC checklist items" ON "public"."qc_checklist_items" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("workers"."role" = 'manager'::"text") AND ("workers"."is_active" = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("workers"."role" = 'manager'::"text") AND ("workers"."is_active" = true)))));



CREATE POLICY "Only managers can modify QC steps" ON "public"."qc_production_steps" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("workers"."role" = 'manager'::"text") AND ("workers"."is_active" = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("workers"."role" = 'manager'::"text") AND ("workers"."is_active" = true)))));
...
CREATE POLICY "Only managers can modify checklist items" ON "public"."qc_checklist_items" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("workers"."role" = 'manager'::"text") AND ("workers"."is_active" = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("workers"."role" = 'manager'::"text") AND ("workers"."is_active" = true)))));
...
CREATE POLICY "QC checklist items are viewable by authenticated users" ON "public"."qc_checklist_items" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "QC steps are viewable by authenticated users" ON "public"."qc_production_steps" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Workers can create repairs" ON "public"."repair_orders" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can insert own QC submissions" ON "public"."qc_submissions" FOR INSERT TO "authenticated" WITH CHECK ((("worker_id" = ( SELECT "workers"."id"
   FROM "public"."workers"
...
CREATE POLICY "Workers can manage knowledge base" ON "public"."repair_knowledge_base" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can manage notifications" ON "public"."repair_notifications" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can manage repair actions" ON "public"."repair_actions" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can manage repair issues" ON "public"."repair_issues" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can manage repair parts" ON "public"."repair_parts_used" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can manage repair photos" ON "public"."repair_photos" USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can manage their own time logs" ON "public"."repair_time_logs" USING (("worker_id" IN ( SELECT "workers"."id"
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can read own QC submissions" ON "public"."qc_submissions" FOR SELECT TO "authenticated" USING ((("worker_id" = ( SELECT "workers"."id"
   FROM "public"."workers"
  WHERE ("workers"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")))) OR (EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("workers"."role" = 'manager'::"text"))))));
...
CREATE POLICY "Workers can update repairs" ON "public"."repair_orders" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can view all knowledge base entries" ON "public"."repair_knowledge_base" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can view all notifications" ON "public"."repair_notifications" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can view all repair actions" ON "public"."repair_actions" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can view all repair issues" ON "public"."repair_issues" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can view all repair parts" ON "public"."repair_parts_used" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can view all repair photos" ON "public"."repair_photos" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can view all repairs" ON "public"."repair_orders" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));



CREATE POLICY "Workers can view all time logs" ON "public"."repair_time_logs" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."workers"
  WHERE (("workers"."auth_user_id" = "auth"."uid"()) AND ("workers"."is_active" = true)))));
...
CREATE POLICY "managers_can_update_workers" ON "public"."workers" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."workers" "current_worker"
  WHERE (("current_worker"."auth_user_id" = "auth"."uid"()) AND ("current_worker"."role" = 'manager'::"text") AND ("current_worker"."is_active" = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."workers" "current_worker"
...
GRANT ALL ON FUNCTION "public"."generate_repair_number"() TO "anon";
GRANT ALL ON FUNCTION "public"."generate_repair_number"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_repair_number"() TO "service_role";
...
GRANT ALL ON TABLE "public"."qc_checklist_items" TO "anon";
GRANT ALL ON TABLE "public"."qc_checklist_items" TO "authenticated";
GRANT ALL ON TABLE "public"."qc_checklist_items" TO "service_role";



GRANT ALL ON TABLE "public"."qc_production_steps" TO "anon";
GRANT ALL ON TABLE "public"."qc_production_steps" TO "authenticated";
GRANT ALL ON TABLE "public"."qc_production_steps" TO "service_role";
...
GRANT ALL ON TABLE "public"."qc_submissions" TO "anon";
GRANT ALL ON TABLE "public"."qc_submissions" TO "authenticated";
GRANT ALL ON TABLE "public"."qc_submissions" TO "service_role";
...
GRANT ALL ON TABLE "public"."repair_actions" TO "anon";
GRANT ALL ON TABLE "public"."repair_actions" TO "authenticated";
GRANT ALL ON TABLE "public"."repair_actions" TO "service_role";



GRANT ALL ON TABLE "public"."repair_issues" TO "anon";
GRANT ALL ON TABLE "public"."repair_issues" TO "authenticated";
GRANT ALL ON TABLE "public"."repair_issues" TO "service_role";



GRANT ALL ON TABLE "public"."repair_knowledge_base" TO "anon";
GRANT ALL ON TABLE "public"."repair_knowledge_base" TO "authenticated";
GRANT ALL ON TABLE "public"."repair_knowledge_base" TO "service_role";



GRANT ALL ON TABLE "public"."repair_notifications" TO "anon";
GRANT ALL ON TABLE "public"."repair_notifications" TO "authenticated";
GRANT ALL ON TABLE "public"."repair_notifications" TO "service_role";
...
GRANT ALL ON TABLE "public"."repair_parts_used" TO "anon";
GRANT ALL ON TABLE "public"."repair_parts_used" TO "authenticated";
GRANT ALL ON TABLE "public"."repair_parts_used" TO "service_role";



GRANT ALL ON TABLE "public"."repair_photos" TO "anon";
GRANT ALL ON TABLE "public"."repair_photos" TO "authenticated";
GRANT ALL ON TABLE "public"."repair_photos" TO "service_role";



GRANT ALL ON TABLE "public"."repair_time_logs" TO "anon";
GRANT ALL ON TABLE "public"."repair_time_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."repair_time_logs" TO "service_role";
